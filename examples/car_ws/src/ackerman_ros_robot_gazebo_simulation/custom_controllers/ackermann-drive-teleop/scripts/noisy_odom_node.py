...
def parse_args():
    ...
    parser.add_argument('--input_topic', type=str, default='/INS/odom', help='Input odometry topic')
    parser.add_argument('--output_topic', type=str, default='/noisy_odom', help='Output odometry topic')

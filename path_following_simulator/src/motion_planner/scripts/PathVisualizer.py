    ...
    def global_path_cb(self, msg):
        if self._load_path_from_file:
            if self._process_path:
                self.file_path = '/home/vialab/path_following_simulator/src/ackerman_ros_robot_gazebo_simulation/custom_controllers/ackermann-drive-teleop/script_for_mpc_prod/data/splined_path.csv'

...
class MotionPlannerNode:
    ...
    def __init__(self, file_path=None, eval_mode=False):
        ...
        if not self.eval_mode:
            self.file_path = rospy.get_param('~path_file_dir', self.basedir + '/path_following_simulator/path/20240404_0400/train/path_147.csv')
            file_path = None
        elif self.eval_mode:
        ...
        if self.ref_path_load_from_file:
            ...
            if self.get_cubic_splined_path:
                ...
                path_folder_splined = self.basedir + "/path_following_simulator/path/20240531_0130_filtered_MATLAB_M_E/splined_path/sparse_{}/".format(skip_points)
        ...
        if self.global_path_receive_flag and not self.ref_path_load_from_file:
            ...
            if self.save_global_path:
                ...
                if not self.manual_path_generation:
                    ...
                    manual_path_folder = self.basedir + '/path_following_simulator/path/manual_generated_path'

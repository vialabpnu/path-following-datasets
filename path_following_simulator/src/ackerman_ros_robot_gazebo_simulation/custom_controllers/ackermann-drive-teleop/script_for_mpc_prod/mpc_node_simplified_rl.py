...
def socket_sending_mpc(path, current_state, vehicle_control, goal_pose=None, goal_verdict=None):
    ...
    if not first_control_obtained:
        ...
        if base_dir is not None:
            if base_dir != '':
                first_control_file = os.path.join(os.environ.get('BASE_DIR'), 'path_following_simulator/src/motion_planner/scripts/control_flag/first_control_obtained.txt')
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path_dir', type=str, default='/home/vialab/path_following_simulator/SLM-Lab/slm_lab/env/car/log/20240411_1520', help='File Path Directory')

...
class ControlCommand:
    ...
    def __init__(self, file_path_name = None, horizon_type="nonuni_sparse_var", eval_path_folder=None):
        ...
        if self.is_sim:
            ...
            delay_yaml_file_dir = os.path.join(self.car_ws_path, "config/delay_params.yaml")
            motion_planner_yaml_file_dir = os.path.join(self.car_ws_path, "config/motion_planner.yaml")
